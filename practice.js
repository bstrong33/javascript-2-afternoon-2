...
let evenFinder = nums => {
  let evensArray = nums.filter(function(val, i, arr){
    return val % 2 === 0;
  })
  return evensArray;
}
...
let divider = numbersArray => {
  let evensArray = numbersArray.filter(function(val, i, arr){
    return val % 2 === 0;
  })
  let oddsArray = numbersArray.filter(function(val, i, arr){
    return val % 2 != 0;
  })
  let Array = [];
  Array.push(evensArray, oddsArray)
  return Array;
}
//Code Here
...
let addTen = numbers => {
  let newArr = numbers.map(function(element){
    let parse = parseInt(element);
    return 10 + parse;
  })
  return newArr;
}
